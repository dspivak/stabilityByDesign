...
Ones intuitions about the world can be cast in the language of the nonnegative reals, $\rrnneg$, which is a highly structured object. Its additive commutative monoid structure $(\rrneg,0,+)$ induces a poset structure $t_1\leq t_2$, defined by. **
