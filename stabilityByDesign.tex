...
\chapter{Adjoint endofunctors of the reals, as simple systems}
\label{}
...
\begin{tikzpicture}
	\draw[->] (0, 0) -- (4, 0);
	\draw[->] (0, 0) -- (0, 2);
	\node[circle, draw, inner sep=1pt, blue, fill] at (2,.8) (cop) {};
	\draw[blue] (0, 0) to[out=5, in=200] (cop);
	\node[circle, draw, inner sep=1pt, blue] at (2,1) (ccl) {};
	\draw[blue, ->] (ccl) to[out=65, in=220] (3.8, 1.7);	
\end{tikzpicture}
\]
